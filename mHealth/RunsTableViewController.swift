...
class RunsTableViewController : UITableViewController{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.dateLabel.text = Util.PastRunsDate(from: run.timestamp)
        cell.timeLabel.text = "\(Util.PastRunsTime(from: run.timestamps.first!)) - \(Util.PastRunsTime(from: run.timestamps.last!))"
